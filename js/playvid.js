...
function queryESsub(id) {    
     $.getJSON("https://raw.githubusercontent.com/espixel/cc/main/es/" + id + ".json", function(json) {     
...
function queryZHsub(id) {
     $.getJSON("https://raw.githubusercontent.com/espixel/cc/main/zh/" + id + ".json", function(json) {     
        //console.log(json); // this will show the info it in firebug console
