            ...
            var appendText = '<div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="' + dataDelay + '">' +
                '<div class="member">' +
                    '<div class="member-img">' +
                        '<a href="./book.html?b_id=' + myBooks[i]['id'] + '">' + '<img src="./assets/img/books/' + myBooks[i]['id'] + '.jpg" class="img-fluid" alt="">' +
                    ...
                    '<div class="member-info">' +
                        ...
                        '<span>' + '<a href="./book.html?b_id=' + myBooks[i]['id'] + '">' + myBooks[i]['author'] + '</span>' +                        
                    '</div>' +
                '</div>' +
            '</div>';
